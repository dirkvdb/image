...
#ifndef IMAGE_LOAD_STORE_JPEG_H
#define IMAGE_LOAD_STORE_JPEG_H
...
class LoadStoreJpeg : public ILoadStore
{
public:
    LoadStoreJpeg();
    virtual ~LoadStoreJpeg();
    
    LoadStoreJpeg(const LoadStoreJpeg&) = delete;
